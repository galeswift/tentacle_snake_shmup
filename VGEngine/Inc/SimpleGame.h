class SimpleGame : public SEngine
{
public:
	SimpleGame()
	{
	...
	void ChangeState( State_Base *NewState );
	void PushState( State_Base *NewState );
	void PopState();
	State_Base* GetCurrentState() { return !States.empty() ? States.back() : NULL; }

	virtual void End();
	virtual void Update( const int &iElapsedTime );
	virtual void Initialized();
	virtual void Render( SDL_Surface* DestinationSurface );	 
...
private:
	vector<State_Base*> States;
};

/* Possible key defines
	SDLK_UNKNOWN		= 0,
	SDLK_FIRST		= 0,
	SDLK_BACKSPACE		= 8,
	SDLK_TAB		= 9,
